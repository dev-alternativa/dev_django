...
class Transportadora(Base):
    ...
    cod_omie_COM = models.CharField('Cód. OMIE COM', max_length=15, null=True)
    cod_omie_IND = models.CharField('Cód. OMIE IND', max_length=15, null=True)
    cod_omie_PRE = models.CharField('Cód. OMIE PRE', max_length=15, null=True)
    cod_omie_MRX = models.CharField('Cód. OMIE MRX', max_length=15, null=True)
...
class ClienteFornecedor(Base):
    ...
    cliente_transportadora = models.ForeignKey('cadastro.Transportadora', verbose_name='Transportadora', on_delete=models.CASCADE)
    prazo = models.ForeignKey('cadastro.Prazo', verbose_name='Prazo', on_delete=models.CASCADE)
...
class Produto(Base):
    ...
    qtd_por_caixa = models.PositiveIntegerField('Quantidade por caixa', null=True)
    ...
    fornecedor = models.ForeignKey('cadastro.ClienteFornecedor', verbose_name='Fornecedor', max_length=100, on_delete=models.CASCADE)
