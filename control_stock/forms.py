      ...
      TabHolder(
        ...
        Tab(
          ...
          Row(
            ...
            Column(
              Field('tag_cadastro_omie_com', css_class='form-control col-md-3 mb-0'),  
              Field('tag_cadastro_omie_ind', css_class='form-control col-md-3 mb-0'),  
              Field('tag_cadastro_omie_pre', css_class='form-control col-md-3 mb-0'),  
            ),
            Column(
              Field('tag_cadastro_omie_mrx', css_class='form-control col-md-3 mb-0'),  
              Field('tag_cadastro_omie_flx', css_class='form-control col-md-3 mb-0'),  
              Field('tag_cadastro_omie_srv', css_class='form-control col-md-3 mb-0'),  
            ),
          ),
        ),
      ),        
