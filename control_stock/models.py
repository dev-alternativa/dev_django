...
class Transportadora(Base):
    ...
    cod_omie_COM = models.IntegerField('Cód. OMIE COM', null=True)
    cod_omie_IND = models.IntegerField('Cód. OMIE IND', null=True)
    cod_omie_PRE = models.IntegerField('Cód. OMIE PRE', null=True)
    cod_omie_MRX = models.IntegerField('Cód. OMIE MRX', null=True)
    cod_omie_SRV = models.IntegerField('Cód. OMIE SRV', null=True)
    cod_omie_FLX = models.IntegerField('Cód. OMIE FLX', null=True)
