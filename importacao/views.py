    ...
    def form_valid(self, form):
        ...
        try:
            ...
            for _, row in df.iterrows():
                obj, created = models.Prazo.objects.get_or_create(
        ...
        try:
            for index, row in df.iterrows():
                try:
                    ...
                    transportadora, created = models.Transportadora.objects.get_or_create(cnpj=cnpj_transportadora)
                    ...
                    if pd.notna(prazo_descricao):
                        prazo_queryset = models.Prazo.objects.filter(descricao=prazo_descricao)
                    ...
                    obj, created = models.ClienteFornecedor.objects.update_or_create(
                      ...
                      # Adiciona as categorias ao objeto com base nos valores das colunas booleanas
                        for categoria_nome in categorias_colunas:
                            if row.get(categoria_nome, 0) == 1: # Verifica se  o valor está como 1 (True)
                                categoria_obj, _ = models.Categoria.objects.get_or_create(nome=categoria_nome)
...
class ImportarTransportadoraView(FormView):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            for _, row in df.iterrows():
                obj, created = models.Transportadora.objects.get_or_create(
    ...
    def form_valid(self, form):
        ...
        for index, row in df.iterrows():
            try:
                ...
                categoria_obj, created = models.Categoria.objects.get_or_create(nome=categoria_nome)

                # Verifica se o fornecedor existe
                try:
                    fornecedor_obj = models.ClienteFornecedor.objects.get(nome_fantasia=fornecedor_nome)
                except models.ClienteFornecedor.DoesNotExist:
                ...
                models.Produto.objects.update_or_create(
